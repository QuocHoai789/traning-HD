    ...
    <div class="col mb-5">
        <div class="card h-100">
            ...
            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{route('post.view', ['id'=>$post->id])}}">View options</a></div>
            </div>
        </div>
    </div> --}}
    <div class="container">
        ...
        {{-- @if(count($category->children))
            @include('frontend.main.post-partial',['cat' => $category->children ])
            @endif --}}
        {{-- </div>
        </div>
