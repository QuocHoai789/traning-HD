...
$config['licenseKey']  = 'P3U34E72A6GWYBQ24MC344JGXNEFD';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      =>  'http://localhost:8080/research/public/upload',
...
//  elseif ($check == 'user') {
//     $config['resourceTypes'][] = array(
//         'name'              => 'Files_user', // Single quotes not allowed.
//         'directory'         => 'files_user',
//         'maxSize'           => 0,
//         'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
//         'deniedExtensions'  => '',
//         'backend'           => 'default'
